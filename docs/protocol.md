        # Evidencehalflife: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/evidencehalflife.git

        ## Objective

        EvidenceHalfLife models the decay of clinical evidence relevance over time, providing quantitative estimates of when existing meta-analyses require updating.
        ...
        - Code: https://github.com/mahmood726-cyber/evidencehalflife.git
